...
output_dir = '/data/mjqzhang/question_generation/totto_qgen/classifier/bert_distant'
...
with open(train_path, 'r') as f:
    distant_data = [json.loads(l) for l in f]
...
print('Loading Distant Dataset')
distant_dataset = ToTToDataset(distant_data, tokenizer)
